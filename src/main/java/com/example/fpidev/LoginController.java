...
public class LoginController {
    ...
    @FXML
    private TextField mdpTextLogin;
    ...
    private void handelLogin(ActionEvent event) throws InvalidAlgorithmParameterException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException {
        try {
            if (!serviceUser.utilisateurLoggedIn(pseudoLogin.getText(), mdpLogin.getText())) {
                ...
                switch (user.getRole()) {
                    case "admin":
                        ...
                        serviceUser.changeScreen(event, "dashboard.fxml", "Client");
                        break;
                    case "client":
    ...
    private void sendMail(ActionEvent event, int Rand){
        ...
        try {
            ...
            try
            {
                ...
                transport.close();
                serviceUser.changeScreen(event, "motDePasseOublie.fxml", "Vérifier le code");
            }catch(Exception e)
            {
    ...
    public void signupLoginButtonOnClick(ActionEvent event){
        serviceUser.changeScreen(event, "signup.fxml", "Sign Up");
    }
